...
// test di mysql other
// test di sql server
class AdisARPage extends Page {
  static $page_class = 'AdisARPage';
...
class AdisARPage_Controller extends Page_Controller {
  static $table_class = 'AdisARModel';
  static $table_detail_class = 'AdisDetailARModel';
  static $table = 'mgartjual';
  static $table_detail = 'mmgartjuald';
  static $pk = 'IdTJual';
  static $pk_detail = 'IdTJualD';
  static $foreign_key = 'IdTJual';
...
//        )
  ...
  function searchajax() {
    ...
    $fieldsort = (isset($_REQUEST['columns'][$columnsort]['data']) && $_REQUEST['columns'][$columnsort]['data']) ? $_REQUEST['columns'][$columnsort]['data'] : self::$pk;
    // ============ end filter
    // SETTING INI
    $where = " " . self::$pk . " != '' ";
    if ($search) {
